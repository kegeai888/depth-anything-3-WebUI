...
class DepthAnything3App:
                ...
                with gr.Column(scale=4):
                    with gr.Column():
                        ...
                        with gr.Tabs():
                            ...
                            with gr.Tab("PLY File Download"):
                                ply_file, ply_info = self.ui_components.create_ply_download_section()
    ...
    def _setup_event_handlers(
        ...
        submit_btn.click(
            ...
            outputs=[
                ...
                ply_file,  # ply_file path
                ply_file,  # ply_file visibility
                ply_info,  # ply_info visibility
            ],
        ).then(
            fn=lambda: "False",
            inputs=[],
    ...
    def _setup_example_scene_handlers(
        ...
        def load_and_update_measure(name):
            ...
            # result = (reconstruction_output, target_dir, image_paths, log_message, processed_data, measure_view_selector, gs_video, gs_video_vis, gs_info_vis, ply_file, ply_file_vis, ply_info_vis)  # noqa: E501
            ...
            if i < len(scene_components):
                scene_components[i].select(
                    ...
                    outputs=[
                        ...
                        ply_file,  # ply_file path
                        ply_file,  # ply_file_visibility
                        ply_info,  # ply_info_visibility
                        is_example,
                        measure_image,
                        measure_depth_image,
                    ],
