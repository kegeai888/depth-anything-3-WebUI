...
class UIComponents:
    ...
    def create_ply_download_section(self) -> Tuple[gr.File, gr.Markdown]:
        """
        Create the PLY file download section.

        Returns:
            Tuple of (file download component, info message component)
        """
        with gr.Column():
            ply_info = gr.Markdown(
                (
                    "📥 **PLY Point Cloud Download** <br><br>"
                    "After clicking **Reconstruct**, the PLY file will be available for download here. <br><br>"
                    "The PLY file contains the 3D point cloud with RGB colors, "
                    "which can be opened in software like MeshLab, CloudCompare, or Blender."
                ),
                visible=True,
                height=520,
            )
